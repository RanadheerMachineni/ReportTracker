			...
			<div class="container" style="padding: 0px;">
				<div class="form-horizontal">
					...
					<div class="form-group" style="margin-left: 0; margin-right: 0;">
						...
						<div class="col-md-5 ">
							<textarea name="txtcnt_Query" rows="2" cols="20"
								id="txtcnt_Query" tabindex="18" class="form-control"
								onblur="hideErrorTip()" onfocus="validateQuery(this)"
								OnKeyUp="chkCharacters()">
</textarea>
						</div>
						<div class="col-md-5"></div>
					</div>
